        ...
        <td width="331" align="right" valign="top">
            <table width="350" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td align="left"></td>
                    <td align="right">
                        <a><b></b><font color="red">欢迎您，${sessionScope.SYS_USER.name}</font></a>
                    </td>
                    ...
                    <td align="left" valign="middle" ><a href="${ctx }/sys/login_logout.do">退出</a></td>
                </tr>
            </table>
        </td>
    </tr>
...
<div class="menu">
    <ul class="clearfix">
        ...
        <li><a href="${ctx }/nsfw/home_frame.do">纳税服务</a> </li>
