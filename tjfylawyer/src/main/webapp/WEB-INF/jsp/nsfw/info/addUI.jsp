...
<form id="form" name="form" action="${basePath }nsfw/info_add.do" method="post" enctype="multipart/form-data">
    <div class="p_d_1">
        <div class="p_d_1_1">
    ...
    <table id="baseInfo" width="100%" align="center" class="list" border="0" cellpadding="0" cellspacing="0"  >
        <tr>
            ...
            <td>
            	 <select name="info.type" id="info_type">
            ...
            <input type="text" name="info.source"/></td>
        </tr>
        <tr>
            <td class="tdBg" width="200px">信息标题：</td>
            <td colspan="3"><!-- <s:textfield name="info.title" cssStyle="width:90%"/> -->
            <input type="text" name="info.title" cssStyle="width:90%"/>
            </td>
        </tr>
        <tr>
            <td class="tdBg" width="200px">信息内容：</td>
            <td colspan="3"><!-- <s:textarea id="editor" name="info.content" cssStyle="width:90%;height:160px;" /> -->
             <textarea id="editor" name="info.content" style="width:90%;height:160px;" ></textarea>
            </td>
        </tr>
        <tr>
            <td class="tdBg" width="200px">备注：</td>
            <td colspan="3"><!-- <s:textarea name="info.memo" cols="90" rows="3"/> -->
            	<textarea name="info.memo" rows="3" cols="90"> </textarea>
            </td>
        </tr>
        <tr>
            ...
            <td>
             	...
             	<input type="text" readonly="readonly" name="info.createTime" name="info.createTime" value="${date}" >
